...
export async function EventRoomServer({ lang }: { lang: 'en' | 'de' }) {
    ...
    return (
        <div className="lg:px-14 px-4 md:px-6 relative bg-rouge">
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 h-full py-8 md:py-10 gap-5 md:gap-20">
                <div className="flex flex-col justify-center items-start md:col-span-1">
